...
namespace FunBooksAndVideos.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IPurchaseOrdersService, PurchaseOrderService>();
            ...
            //Register rules here
            services.AddTransient<IPurchaseOrderRule, ShippingSlipRule>();
            services.AddTransient<IPurchaseOrderRule, CustomerMembershipRule>();
        }
